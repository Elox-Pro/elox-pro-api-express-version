/**
 * Simple TypeScript/Node.js Dependency Injection Container
 * 
 * This module provides a lightweight and easy-to-use
 * dependency injection (DI) manager for TypeScript and Node.js applications.
 * It allows developers to define and inject dependencies into their classes,
 * promoting cleaner and more testable code.
 * 
